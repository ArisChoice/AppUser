...
public class HorizontalListAdapter extends RecyclerView.Adapter<HorizontalListAdapter.OptionViewHolder> {
    ...
    public HorizontalListAdapter(FragmentActivity activity, List<BarberListResponseModel.ListBean> barberList, String fromScreen, OnItemClickListener listener) {
    ...
    public OptionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_horizontal_barber_adapter, parent, false);
    ...
    public void onBindViewHolder(OptionViewHolder holder, int position) {
        ...
        if (positionData.getDistance() != null && !positionData.getDistance().equals("")) {
            holder.barberDistance.setText(positionData.getDistance() + GlobalValues.DistanceType.MILES);
        }

        if (positionData.isSuperBarber()) {
            holder.barrberStatus.setVisibility(View.VISIBLE);
        } else {
            holder.barrberStatus.setVisibility(View.GONE);
        }
    }
